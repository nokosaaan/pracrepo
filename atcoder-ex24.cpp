...
struct Clock{
    ...
    string to_str(){
        ...
        if(second<10 && minute<10 && hour<10){
            s='0'+to_string(hour)+':'+'0'+to_string(minute)+':'+'0'+to_string(second);
        }
        else if(second<10 && minute<10){
            s=to_string(hour)+':'+'0'+to_string(minute)+':'+'0'+to_string(second);
        }
        else if(second<10 && hour<10){
            s='0'+to_string(hour)+':'+to_string(minute)+':'+'0'+to_string(second);
        }
        else if(minute<10 && hour<10){
            s='0'+to_string(hour)+':'+'0'+to_string(minute)+':'+to_string(second);
        }
        else if(second<10){
            s=to_string(hour)+':'+to_string(minute)+':'+'0'+to_string(second);
        }
        else if(minute<10){
            s=to_string(hour)+':'+'0'+to_string(minute)+':'+to_string(second);
        }
        else if(hour<10){
            s='0'+to_string(hour)+':'+to_string(minute)+':'+to_string(second);
        }
        else 
